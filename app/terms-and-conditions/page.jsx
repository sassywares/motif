...
export const metadata = {
  title: "Terms and Conditions — Motif studio",
          ...
          <main id="main" className="page-section">
            <div className="container position-relative">
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Motif studio, accessible
                    from{" "}
                    <a
                      href="https://motif.pages.dev"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://motif.pages.dev
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  By email:{" "}
                  <a
                    href="mailto:hello@motif.pages.dev"
                    className="text-primary"
                  >
                    hello@motif.pages.dev
                  </a>
                </li>
              </ul>
            </div>
