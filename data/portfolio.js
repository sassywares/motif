...
export const portfolios1 = [
  {
    id: 7,
    className: "work-item mt-90 mt-md-0 mix residential",
    href: "",
    linkClassName: "work-lightbox-link mfp-image",
    imgSrc: "/assets/images/works/parisian-elegance.jpg",
    imgAlt: "Modern Parisian Apartment",
    delay: "1s",
    title: "Parisian Elegance",
    description:
      "A contemporary apartment blending classic French details with modern minimalism",
  },
  {
    id: 8,
    className: "work-item mix commercial",
    href: "",
    linkClassName: "work-ext-link",
    imgSrc: "/assets/images/works/lyon-boutique.jpg",
    imgAlt: "Boutique Retail Space",
    delay: "1s",
    title: "Lyon Boutique",
    description:
      "Luxurious retail environment designed to enhance brand experience and customer flow",
  },
  {
    id: 9,
    className: "work-item mt-90 mt-md-0 mix hospitality",
    href: "",
    linkClassName: "work-ext-link",
    imgSrc: "/assets/images/works/rivera-hotel.jpg",
    imgAlt: "Luxury Hotel Lobby",
    delay: "1s",
    title: "Riviera Hotel",
    description:
      "Sophisticated coastal-inspired lobby creating a seamless indoor-outdoor experience",
  },
  {
    id: 10,
    className: "work-item mix residential commercial",
    href: "",
    linkClassName: "work-ext-link",
    imgSrc: "/assets/images/works/marseille-office.jpg",
    imgAlt: "Modern Office Space",
    delay: "1s",
    title: "Marseille Office",
    description:
      "Versatile workspace balancing productivity, collaboration, and French Mediterranean style",
  },
  {
    id: 11,
    className: "work-item mix residential",
    href: "",
    linkClassName: "work-ext-link",
    imgSrc: "/assets/images/works/provence-villa.jpg",
    imgAlt: "Minimalist Villa Design",
    delay: "1s",
    title: "Provence Villa",
    description:
      "Countryside retreat featuring natural materials and harmonious indoor-outdoor living",
  },
  {
    id: 12,
    className: "work-item mix commercial hospitality",
    href: "",
    linkClassName: "work-lightbox-link mfp-image",
    imgSrc: "/assets/images/works/bistro-montmartre.jpg",
    imgAlt: "Café Interior Design",
    delay: "1s",
    title: "Bistro Montmartre",
    description:
      "Charming café design capturing authentic Parisian atmosphere with contemporary touches",
  },
  {
    id: 13,
    className: "work-item mix residential",
    href: "",
    linkClassName: "work-lightbox-link mfp-image",
    imgSrc: "/assets/images/works/seine-penthouse.jpg",
    imgAlt: "Luxurious Penthouse",
    delay: "1s",
    title: "Seine Penthouse",
    description:
      "Opulent urban residence with panoramic river views and bespoke furnishings throughout",
  },
  {
    id: 14,
    className: "work-item mix hospitality",
    href: "",
    linkClassName: "work-lightbox-link mfp-image",
    imgSrc: "/assets/images/works/cannes-restaurant.jpg",
    imgAlt: "Restaurant Interior",
    delay: "1s",
    title: "Cannes Restaurant",
    description:
      "Elegant dining space merging cinematic glamour with sophisticated coastal elements",
  },
];
