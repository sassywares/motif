export const services = [
  {
    ...
    description:
      "We transform living spaces into personalized sanctuaries that reflect your unique lifestyle and aesthetic preferences. Our approach combines French design principles with contemporary functionality to create homes that are both beautiful and livable.",
  },
  {
    number: "02",
    ...
    description:
      "From boutique retail environments to hospitality venues, we design commercial spaces that create memorable experiences while optimizing functionality. Our commercial designs balance brand identity with spatial innovation and attention to user experience.",
  },
  {
    number: "03",
    ...
    description:
      "Our bespoke furniture design service creates unique pieces that perfectly complement your space. Working with skilled French artisans, we craft furniture that combines traditional craftsmanship with contemporary sensibilities, resulting in enduring statement pieces.",
  },
  {
    number: "04",
    ...
    description:
      "We specialize in respectfully renovating historical properties while introducing modern comforts. Our expertise in French architectural heritage allows us to preserve the character and details of period buildings while adapting them for contemporary living.",
  },
];
...
export const services2 = [
  {
    ...
    text: "Our comprehensive space planning service optimizes flow, functionality, and aesthetic harmony in your environment. We analyze spatial relationships to create layouts that enhance both beauty and usability.",
    categories: [
      "Spatial Analysis",
  ...
  },
  {
    ...
    text: "We source exceptional materials that elevate your interior design with texture, color, and quality. Our curated selections balance luxury with sustainability, featuring both traditional French and contemporary options.",
    categories: [
      "Textile Curation",
      "Finish Selection",
  ...
  },
  {
    ...
    text: "Our lighting design creates atmosphere and enhances architectural features while providing functional illumination. We combine technical expertise with artistic vision to develop lighting schemes that transform spaces day and night.",
    categories: [
      "Ambient Lighting",
  ...
  },
  {
    ...
    text: "Our color consultation service helps you discover the perfect palette for your space. Drawing from French color theory and contemporary trends, we create harmonious combinations that evoke specific moods and enhance architectural features.",
    categories: [
      "Palette Development",
      "Paint Specification",
      "Color Psychology",
