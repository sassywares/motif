            ...
            <>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Elegance</div>
                  <div className="features-descr">
                    We create sophisticated spaces that balance classic French
                    design principles with contemporary aesthetics, bringing
                    timeless elegance to every project.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Craftsmanship</div>
                  <div className="features-descr">
                    We collaborate with skilled artisans who bring exceptional
                    craftsmanship to every element, ensuring quality materials
              ...
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Harmony</div>
                  <div className="features-descr">
                    We create balanced compositions where color, texture,
                    proportion, and light work in perfect harmony to evoke a
                    sense of tranquility and visual coherence.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  <div className="features-icon">
                    <svg
                      ...
                      clipRule="evenodd"
                    >
                      <path d="M24 5.252v14.883l-12 2.723-12-2.723v-14.883l12-2.723 12 2.723zm-1 1.127l-10 2.268v12.319l10-2.269v-12.318zm-11 2.268l-10-2.268v12.318l10 2.269v-12.319zm-5.506 3.178c.976.165 1.029-.678 1.029-.778 0-.236-.08-.581-1.026-.779-1.78-.363-1.822-1.643-1.822-2.232 0-1.515 1.058-2.016 1.705-2.016.8 0 1.054.125 1.339.274l.133-.639c-.458-.174-.956-.391-1.441-.391-1.581 0-2.487 1.179-2.487 2.55 0 .357 0 1.693 1.777 2.129 1.775.435 1.718 1.306 1.745 1.604.019.215-.033 1.006-1.205.81-1.123-.188-1.318-.381-1.318-.381l-.164.647c.159.072.583.256 1.735.422zm6.506-2.943l.32-.63-2.044-.423v-2.312l-.703.158v6.281l.246.051c1.399.287 2.249-.469 2.249-1.598 0-.912-.399-1.322-1.741-1.643l-.32-.084v-1.887l2 .413-.007 1.674zm0 3.145c0 .526-.369.903-1.108.74l-.185-.038v-2.523l.322.088c.717.194.971.528.971 1.051v.682zm4 .004c0 .608-.319 1.175-1.157 1.388l-1.786.388-.057-6.061 1.725-.39c.717-.155 1.201.016 1.201.542 0 .494-.146.969-.438 1.179.877.204 1.512.459 1.512 1.451v1.503zm-1-2.418c0-.311-.119-.458-.396-.397l-.547.122-.057 1.271.426-.096c.268-.058.574-.256.574-.69v-.21zm0 2.442c0-.781-1.222-.735-1.222-.735l.079 1.749.692-.153c.318-.067.451-.225.451-.442v-.419z" />
                    </svg>
                  </div>
                  <div className="features-title">Personalization</div>
                  <div className="features-descr">
                    We believe each space should reflect the personality and
                    lifestyle of its inhabitants, creating environments that
